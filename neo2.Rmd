...
x <- head(neo) ## OK
tbl(x, caption = "Raw individual data.")
```
...
X <- head(tneo)
##summary(tneo)
tbl(X, caption = "Same data, tabular form.")
...
The age interval is cut into 28 pieces, "0-1", "1-2", etc., so the underlying statistical survival model is that of a *piecevise constant hazards*.

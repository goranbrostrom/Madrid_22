...
** Run this (and only this) before running "paper4.Rmd"!**
...
per$socst[is.na(per$socst)] <- 0
per$socst <- factor(per$socst, labels = c("none", "highBusiness", "highOfficial", "farmer", "lowBusiness",
                                          "lowOfficial", "qualWorker", "farmhand", "unqualWorker"))
...
per <- per[, c("id", "sex", "birthdate", "mid", "foddat", "parity", "illeg", "socst",
               "subreg", "socBranch", "socStatus", "hisclass", "urban", "enter", "exit", "event")]
...
tempvars <-  c("heat", "heat.1", "extemp", "extemp.1", "cold", "cold.1", "emintemp", "emeantemp", "emaxtemp", 
               "week", "year") 
## Ume:
...
infdat <- infdat[order(infdat$id, infdat$enter), c("subreg", "id", "sex", "enter", "exit", "event", 
                                                   "birthmonth", "period", "socBranch", "socStatus", "socst", "illeg",
                                                   "parity", "hisclass", "urban", tempvars)]
## New addition: (28 Jan 2022)
##infdat <- rc(infdat) # rc from 'skum'
##n <- NROW(infdat)

saveRDS(infdat, file = "data/infdat4.rds") # NOTE: Name change!!!

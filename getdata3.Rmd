...
1.    (December 22, 2021) I have come to the conclusion that data from the data frame 
*persons* is the best and easiest start.

2.    (January 27. 2022) I found that temperature reports from *Stensele* are very similar
to those from the very similar *Umeå* and *Skellefteå*. 

3.    (February 5, 202). Conclusion: The Skellefteå inland is now included. But with 
summer temperatures from *Bjuröklubb*.


We start with *skum::persons* instead of *skum::obs*, and age is to begin with in days,
...
tempvars <-  c("heat", "heat.1", "aver", "aver.1", "cold", "cold.1", "emintemp", "emeantemp", "emaxtemp", 
               "week", "year") 
## Ume:
...
infdat <- infdat[order(infdat$id, infdat$enter), c("subreg", "id", "sex", "enter", "exit", "event", 
                                                   ...
                                                   "parity", "hisclass", tempvars)]
## New addition: (28 Jan 2022)
infdat <- rc(infdat) # rc from 'skum'
n <- NROW(infdat)

saveRDS(infdat, file = "data/infdat3.rds") # NOTE: Name change!!!

```

Note the name change of the data file: *infdat3.rds*! And the the time lag is `r lagg`.

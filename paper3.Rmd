...
The analysis is split into two parts by season, *winter + spring* is one, and *summer + fall* the other.
...
winter <- tpneo[tpneo$season %in% c("winter", "spring"), ]
winter$season <- factor(winter$season)

fit.tpch <- tpchreg(oe(event, exposure) ~ lowTemp + highTemp + aver + emeantemp + sex + socBranch + socStatus  + 
                        illeg + parity + subreg, 
...
summer <- tpneo[tpneo$season %in% c("summer", "fall"), ]
winter$season <- factor(winter$season)

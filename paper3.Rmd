...
ltx2(fit.tpch, dr = dr, caption = "Postneonatal mortality, winter and spring. Adjusted for social status and branch, sex, illegitimacy, parity, time period, and subregion.", label = "tab:postanalw", keep = NULL)
```
...
dr <- drop1(fit.tpch, test = "Chisq")
ltx2(fit.tpch, dr = dr, caption = "Postneonatal mortality, winter and spring. Adjusted for social status and branch, sex, illegitimacy, parity, time period, and subregion.", label = "tab:postanals", keep = NULL)
```
...
## Separate exogeneous and endogeneous Infant mortality
...
fit.c <- coxreg(Surv(enter, exit, event) ~ 1, data = infdat)
fit.w <- phreg(Surv(enter, exit, event) ~ 1, data = pneo)
cc <- hazards(fit.c)

...
findings by Bourgeois-Pichat [@bp51a;  @bp51b] about endogenous and exogenous mortality and the log-cube transform,
...
fit.ph <- coxph(Surv(enter, exit, event) ~  socStatus + illeg + parity + period + socBranch  + cold + emintemp + subreg + season,
